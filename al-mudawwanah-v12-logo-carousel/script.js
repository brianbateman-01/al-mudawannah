...
/* =========================================================
   AL MUDAWWANAH — TEACHERS CAROUSEL
========================================================= */

document.addEventListener("DOMContentLoaded", function () {

  const track = document.getElementById("teachersTrack");
  const prevButton = document.getElementById("teacherPrev");
  const nextButton = document.getElementById("teacherNext");
  const dotsContainer = document.getElementById("teacherDots");
  ...
  const cards = Array.from(
    track.querySelectorAll(".teacher-card")
  );
  ...
  function updateCarousel() {
    ...
    const dots =
      dotsContainer.querySelectorAll(".teacher-dot");
